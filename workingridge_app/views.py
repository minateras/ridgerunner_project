...
from .models import Date2, Dog2, Kennel2, Sport2
    ...
    if request.method == 'POST':
        try:
            if request.POST.get('sport') is not None:
                ...
                if (sport[0], sport[1]) not in Sport2.VALID_SPORTS: raise Exception
            ...
            return defaults.bad_request(request, exception, template_name='400.html')
    date = Date2.get_date()
