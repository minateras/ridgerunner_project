...
(2, 'en', 'READ ABOUT HAPPY', 'Today - exactly 5 years since I (Mina) got Heera - I brought home my second RR: Lejonessa Air Of Happiness. Her name is Happy and my ambition is to compete with her in the same sports as Heera, but with an additional focus on messaging.</p><p>If she stays healthy and proves to have a good mentality, we hope to use her in our breeding program in the future.</p><p>Read more about Happy on her own <a href=''./dogs/lejonessa_air_of_happiness''>page</a>.</p>'),
(2, 'sv', 'LÄS OM HAPPY', '<p>Idag - exakt 5 år sedan jag (Mina) skaffade Heera - hämtade jag hem min andra RR: Lejonessa Air Of Happiness. Hon heter Happy och min ambition är att tävla med henne i samma sporter som Heera, men med ytterligare fokus på bruksgrenen rapport.</p><p>Om hon tillåts vara frisk och visar sig ha en god mentalitet så hoppas vi använda henne i vårt avelsprogram i framtiden.</p><p>Läs mer om Happy på hennes egna <a href=''./dogs/lejonessa_air_of_happiness''>sida</a>.</p>'),
(3, 'en', 'APPROVED KENNEL NAME', '<p>Today - May 31, 2024 - our kennel name Messenger Dog was registered!</p><p>The name is inspired by my (Mina''s) favorite sport: messaging! The sport originates from the First World War and the dogs that ran between the bases to deliver messages [1].</p><p>We are looking forward to the kennel''s first litter of puppies! Together we hope to fulfill the dream of working ridgebacks suitable for dog sports. Read more about our breeding goals <a href=''./about_us''>here</a>.</p><cite>[1] <a href=''https://americacomesalive.com/national-mutts -day-july-31-a-brave-and-remarkable-messenger-dog/'' target=''_blank''>World War I and a Remarkable Messenger Dog</a></cite>'),
(3, 'sv', 'GODKÄNT KENNELNAMN', '<p>Idag - 31 maj 2024 - blev vårt kennelnamn Messenger Dog registrerat!</p><p>Namnet är inspirerat efter min (Minas) favoritgren: bruksgrenen rapport! Messenger Dog är nämligen det engelska ordet för rapporthund. Rapporten härstammar från första världskriget och de hundar som sprang bud mellan baserna [1].</p><p>Vi ser fram emot efter kennelns första valpkull! Tillsammans hoppas vi uppfylla drömmen om arbetande ridgebacks passande för hundsport. Läs mer om våra avelsmål <a href=''./about_us''>här</a>.</p><cite>[1] <a href=''https://americacomesalive.com/national-mutts-day-july-31-a-brave-and-remarkable-messenger-dog/'' target=''_blank''>World War I and a Remarkable Messenger Dog</a></cite>'),
