...
(
    ...
    31,
    NULL,
    'ridgerunner_app/assets/images/happy/BPH.png',
    '[1.5, 18.0, 13.0]',
    NULL,
    NULL,
    '["Mina Teräs"]',
...
(2, 'en', '<p>Happy will not be bred until she is at least 3 years old and she will therefore be mated in the spring of 2026 at the earliest. Male has not yet been decided.</p>', '<p>TBA</p>'),
(2, 'sv', '<p>Happy kommer inte avlas på förrän hon är åtminstone 3 år gammal och hon kommer därför paras tidigast våren 2026. Hane är ännu inte bestämt.</p>', '<p>TBA</p>');
...
(1, 'en', 'READ ABOUT HEERA', '<p>On May 2, 2018, I brought home my first dog: Kadamo I Am Bagheera. Her name is Heera and my ambition is to compete with her in obedience and working dog trials (mainly messaging).</p><p>Read more about Heera on her own <a href=''./dogs/kadamo_i_am_bagheera''>page</a>.</p>'),
(1, 'sv', 'LÄS OM HEERA', '<p>Den 2 maj 2018 hämtade jag hem min första hund: Kadamo I Am Bagheera. Hon heter Heera och min ambition är att tävla med henne i lydnad och bruks (främst grenen rapport).</p><p>Läs mer om Heera på hennes egna <a href=''./dogs/kadamo_i_am_bagheera''>sida</a>.</p>'),
...
(4, 'en', 'PLANNED LITTER', '<p>We are planning our first litter for 2026 or 2027.</p><p>The plan is to mate Happy. It will be her first litter. Male is not determined but we have a list of interesting males. We are looking for a male with the following characteristics: easily rewarded, fearless, curious and socially confident. It is also important that the male is around 65 cm in height and weighs a maximum of about 40 kg. We appreciate if the male is qualified in dog sports or is closely related to dogs that are, but it is not a requirement. The mentality and how he matches up with Happy is the most important in our choice. You can read more about Happy on her own <a href=''./dogs/lejonessa_air_of_happiness''>page</a>.</p><p>If you have a male that you think might be interesting or if you are interested in a puppy after Happy, you are welcome to get in touch. If you are seriously interested, we can also set up a meeting.</p>'),
(4, 'sv', 'PLANERAD VALPKULL', '<p>Vi planerar vår första kull till 2026 eller 2027.</p><p>Planen är att para Happy. Det blir hennes första kull. Hane är inte bestämd men vi har en lista med intressanta hanar. Vi letar efter en hane med följande egenskaper: lättbelönad, orädd, nyfiken och socialt självsäker. Viktigt är också att hanen är ca 65 cm i mankhöjd och väger max ca 40 kg. Vi uppskattar om hanen är meriterad i hundsport eller är nära besläktad med hundar som är det, men det är inget krav. Mentaliteten och hur han matchar med Happy väger tyngst i vårt val. Du kan läsa mer om Happy på hennes egna <a href=''./dogs/lejonessa_air_of_happiness''>sida</a>.</p><p>Om du har en hane som du tror kan vara intressant eller om du är sugen på en valp efter Happy är du välkommen att höra av dig. Om du är seriöst intresserad kan vi också boka in ett tillfälle där du får träffa mig och Happy.</p>');
